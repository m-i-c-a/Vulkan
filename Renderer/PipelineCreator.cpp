...
VkDevice PipelineCreator::m_VkDevice = VK_NULL_HANDLE;
VkExtent2D PipelineCreator::m_VkSwapchainExtent = { 0, 0 };
VkFormat PipelineCreator::m_VkSwapchainFormat = VK_FORMAT_UNDEFINED;

std::vector<VkDescriptorSetLayout> PipelineCreator::createDefaultDescriptorSetLayouts()
{
    ...
    VK_CHECK(vkCreateDescriptorSetLayout(m_VkDevice, &frameSetCreateInfo, nullptr, &layouts[0]));

    return layouts;
}

VkPipelineLayout PipelineCreator::createDefaultPipelineLayout(std::vector<VkDescriptorSetLayout>& layouts)
{
    ...
    VK_CHECK(vkCreatePipelineLayout(m_VkDevice, &pipelineLayoutCreateInfo, nullptr, &pipelineLayout));
    return pipelineLayout;
}

VkPipeline PipelineCreator::createDefaultPipeline(VkPipelineLayout layout)
{
    const std::array<VkPipelineShaderStageCreateInfo, 2> pipelineShaderStageCreateInfo{{{.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO,
                                                                                         ...
                                                                                         .module = createShaderModule(m_VkDevice, "../shaders/default-vert.spv"),
                                                                                         .pName = "main",
                                                                                         .pSpecializationInfo = nullptr},
                                                                                        {.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO,
                                                                                         .stage = VK_SHADER_STAGE_FRAGMENT_BIT,
                                                                                         .module = createShaderModule(m_VkDevice, "../shaders/default-frag.spv"),
                                                                                         .pName = "main",
                                                                                         .pSpecializationInfo = nullptr}}};
    ...
    const VkViewport viewport{
        .x = 0,
        .y = 0,
        .width = static_cast<float>(m_VkSwapchainExtent.width),
        .height = static_cast<float>(m_VkSwapchainExtent.height),
        .minDepth = 0.0f,
        .maxDepth = 1.0f,
    };
    ...
    const VkPipelineRenderingCreateInfoKHR pipelineRenderingCreateInfo{
        ...
        .pColorAttachmentFormats = &m_VkSwapchainFormat};
    ...
    VkPipeline pipeline;
    VK_CHECK(vkCreateGraphicsPipelines(m_VkDevice, VK_NULL_HANDLE, 1, &graphicsPipelineCreateInfo, nullptr, &pipeline));

    vkDestroyShaderModule(m_VkDevice, pipelineShaderStageCreateInfo[0].module, nullptr);
    vkDestroyShaderModule(m_VkDevice, pipelineShaderStageCreateInfo[1].module, nullptr);
